...
The development environment pins File Transformation `3.0.1.0` with archive ABI `12.0.0`. File Transformation 3.0.1.0 publishes one archive per Jellyfin ABI: use `Release-12.0.0.zip` for Jellyfin 12.
