...
- **Docker** and **Docker Compose** (plugin development always runs inside the pinned `.NET SDK 10.0.401` container image, so a local .NET installation is not required)
